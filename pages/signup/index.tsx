...
import { SignupFormData, PasswordStrength } from "@/interface";
...
export default function SignupPage() {
  ...
  // Password strength indicator - Fixed with proper typing
  ...
  const passwordStrength: PasswordStrength = getPasswordStrength();

  return (
    <div className="min-h-screen bg--to-br from-blue-50 via-white to-purple-50 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
          ...
          {success && (
            <div className="mb-6 p-4 bg-green-50 border border-green-200 rounded-lg flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-green-600">Welcome to Mimi Store...</p>
              </div>
            </div>
          )}
